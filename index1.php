	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" action="auth.php" class="login100-form validate-form">
					...
					<button type="button" class="btn btn-info"><a href="Register.php">Not Registered Yet?</a></button>
						</div>				
				</form>
			</div>
		</div>
